...
| Messenger | `com.facebook.orca` | <ul><li>Disable typing indicator</li><li>Hide inbox ads</li><li>Hide inbox stories and notes tray</li><li>Hide inbox subtabs</li><li>Hide Facebook buttons</li><li>Remove Meta AI</li><li>Open links externally</li></ul> |
